# =============================================================================
# B01 - PIXEL PUT 03: mlx_pixel_put with explicit mlx_sync flush
# =============================================================================
#
# HYPOTHESIS & CONCLUSION:
#   mlx_pixel_put is non-functional on this build. Called correctly,
#   inside the loop, with an explicit flush - zero pixels rendered.
#   Use write_pixel via the image buffer instead.
#
# TRY THIS:
#   1. Run the script - press SPACE.
#   2. Terminal confirms 90,000 calls + explicit SYNC_WIN_FLUSH.
